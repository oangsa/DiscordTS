...
import { getChunkTimeMs, getLastStopTime, secondsToBuffer, syncStream } from '../utils/ReplayReadable.utils';
import type { BufferArrayElement, ChunkArrayItem, EncodingOptions, ReadWriteOptions } from '../interfaces/IVoiceRecorder';
import type IReplayReadable from '../interfaces/IReplayReadable';
type Timer = NodeJS.Timer;

export class ReplayReadable extends Writable implements IReplayReadable {
    ...
    private readonly fadeOutInterval: Timer;
    ...
    constructor(lifeTimeMs: number, sampleRate: any, numChannels: number, private getUserSpeakingTime: () => number | undefined, options?: ReadWriteOptions) {
